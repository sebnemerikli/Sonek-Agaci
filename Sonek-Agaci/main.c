...
Bundan sonra gerceklesecek islemler, komut satirindan alinan probleme göre sekillenecektir.
(Her problem fonksiyonunun icinde sonek agacini en bastan olusturarak is yükü yaratmamak adina problem fonksiyonlarimizdan önce sonek agacimizi olusturduk.)*/
